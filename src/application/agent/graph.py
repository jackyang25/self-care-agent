...
from src.application.agent.nodes import create_reasoning_node, create_tools_node, routing_node
...
def create_agent_graph(llm_model: str, temperature: float) -> Any:
    ...
    workflow.add_conditional_edges("reasoning", routing_node, {"tools": "tools", "end": END})
