...
def order_commodity_tool(
    ...
    safety boundaries:
    - this tool handles fulfillment/logistics; it does not validate medical appropriateness.
    - if the user is symptomatic, run triage first (prefer `assess_verified_triage_tool`) and use `search_knowledge_base_tool` to ground any self-care or medication guidance.
