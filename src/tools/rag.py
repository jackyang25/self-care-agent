...
class RAGInput(BaseModel):
    ...
    query: str = Field(description="search query to find relevant knowledge base documents")
    content_type: Optional[str] = Field(
        None, description="filter by content type (e.g., 'protocol', 'guideline', 'treatment')"
    )
